...
const LeadForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setStatus('success');
      setFormData({ name: '', phone: '', city: '', serviceType: 'התקנת פרקט (למינציה / עץ / פולימרי)' });
    }, 1500);
  };
    ...
    <section id="contact-form" className="bg-timber-black text-white">
      <div className="flex flex-col md:flex-row min-h-[800px]">
        ...
        <div className="w-full md:w-1/2 p-12 md:p-24 flex flex-col justify-center order-2 md:order-1">
          <span className="text-timber-accent font-bold tracking-[0.2em] text-xs uppercase mb-6">
            Get In Touch
          </span>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              <div className="space-y-8">
                <div className="relative group">
                  ...
                  />
                  <label className="absolute right-0 top-4 text-gray-500 text-sm font-bold uppercase tracking-wider duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[100%_0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:text-white">
                    שם מלא
                  </label>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="relative group">
                    ...
                    <label className="absolute right-0 -top-2 text-gray-500 text-[10px] font-bold uppercase tracking-widest">
                      מה מעניין אתכם?
                    </label>
                  </div>
                </div>
        ...
        {/* Image Side - Ensured to fill height */}
