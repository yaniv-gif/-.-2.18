...
const BeforeAfter: React.FC = () => {
  ...
  // Images representing a messy/old floor vs a perfect new one
  const beforeImage = "https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2670&auto=format&fit=crop"; // Construction/Raw
  const afterImage = "https://images.unsplash.com/photo-1595428774223-ef52624120d2?q=80&w=2574&auto=format&fit=crop"; // Perfect Finish

  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center text-center mb-12 reveal">
          <span className="text-xs font-bold tracking-[0.2em] uppercase text-gray-400 mb-4">Transformation</span>
          <h2 className="text-4xl md:text-5xl font-black text-timber-black tracking-tighter">
            המהפך המושלם
          </h2>
        ...
        >
          ...
          <img 
            src={beforeImage} 
            alt="לפני ואחרי חידוש רצפת פרקט ג'ריקו אספינוזה" 
